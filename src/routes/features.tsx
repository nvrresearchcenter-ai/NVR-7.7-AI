    ...
    <div style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      >
        ...
        >
          <div>
            ...
            <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
              ...
              <Link to="/" className="btn-ghost" style={{ fontSize: '0.9375rem', padding: '13px 32px' }}>
                Try the chat
              </Link>
            </div>
            ...
            >
              {[
                ...
                <div key={s.val}>
                  <p style={{ fontFamily: 'DM Mono, monospace', fontSize: '1.25rem', fontWeight: 500, color: 'var(--accent)', letterSpacing: '-0.02em', marginBottom: '2px' }}>
                    {s.val}
                  </p>
        ...
        <style>{`
          @media (max-width: 768px) {
            .features-hero-grid { grid-template-columns: 1fr !important; gap: 48px !important; }
          }
        `}</style>
      </section>
      ...
      <section style={{ padding: '96px 24px' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div style={{ marginBottom: '64px' }}>
            ...
            <h2 style={{ fontSize: 'clamp(1.75rem, 3vw, 2.5rem)', fontWeight: 800, color: 'var(--text-primary)', maxWidth: '540px', marginBottom: '16px' }}>
              Built for precision, designed for scale
            </h2>
            <p style={{ color: 'var(--text-secondary)', maxWidth: '480px', fontSize: '1rem', lineHeight: 1.7 }}>
      ...
      >
        ...
        >
          ...
          <h2 style={{ fontSize: 'clamp(1.75rem, 3.5vw, 2.5rem)', fontWeight: 800, color: 'var(--text-primary)', marginBottom: '16px' }}>
  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 1, marginBottom: '20px' }}>
        <p style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 'clamp(1.25rem, 2.6vw, 1.75rem)', color: 'var(--text-primary)', lineHeight: 1.05, marginBottom: '8px' }}>
          NVR 7.7 AI Model
        </p>
        <p style={{ fontFamily: 'Syne, sans-serif', fontWeight: 700, fontSize: 'clamp(0.875rem, 1.6vw, 1.0625rem)', background: 'linear-gradient(90deg, var(--accent), #22c55e)', WebkitBackgroundClip: 'text', backgroundClip: 'text', WebkitTextFillColor: 'transparent', lineHeight: 1.25 }}>
